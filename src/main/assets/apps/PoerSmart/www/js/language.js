...
//		Russain: "",
	...
	owner.label_copy = function(language) {
		switch (language) {
			...
			case LANG_BLR:
				return "";
			case LANG_ROM:
				return " - copiaza in zilele selectate";
			default:
				return "Copy";
		}
	}
	...
	owner.label_devicetype_array = function(language) {
		switch (language) {
			...
			case LANG_ESP:
				return "";
			case LANG_RUS:
				return ['Температура','Сигнализатор'];
			case LANG_BLR:
				return "";
			case LANG_ROM:
	...
	owner.label_password_too_short = function(language) {
		switch (language) {
			...
			case LANG_BLR:
				return "";
			case LANG_ROM:
				return "Parola aleasa este prea scurta (lungimea acceptata are intre 3 si 15 caractere)!";
			default:
				return "Password is too short! The valid length is 3~15";
		}
	}
	...
	owner.label_password_too_long = function(language) {
		switch (language) {
			...
			case LANG_BLR:
				return "";
			case LANG_ROM:
				return "Parola aleasa este prea lunga (lungimea acceptata are intre 3 si 15 caractere)!";
			default:
				return "Password is too long! The valid length is 3~15";
		}
	}
	...
	owner.label_newpassword_too_short = function(language) {
		switch (language) {
			...
			case LANG_BLR:
				return "";
			case LANG_ROM:
				return "Parola aleasa este prea scurta (lungimea acceptata are intre 3 si 10 caractere)!";
			default:
	...
	owner.label_newpassword_too_long = function(language) {
		switch (language) {
			...
			case LANG_BLR:
				return "";
			case LANG_ROM:
				return "Parola aleasa este prea lunga (lungimea acceptata are intre 3 si 10 caractere)!";
			default:
				return "New password is too long! The valid length is 3~10";
		}
	}
	...
	owner.label_confirm_password_error = function(language) {
		switch (language) {
			...
			case LANG_BLR:
				return "";
			case LANG_ROM:
				return "Parolele noi sunt diferite! Reintroduceti-le corect.";
			default:
				return "Password is different from confirm password";
		}
	}
	...
	owner.label_new_confirm_password_error = function(language) {
		switch (language) {
			...
			case LANG_BLR:
				return "";
			case LANG_ROM:
				return "Parola este diferita de cea introdusa anterior!";
			default:
				return "New password is different from confirm password";
		}
	}
	...
	owner.label_change_workmode_to = function(language) {
		switch (language) {
			...
			case LANG_BLR:
				return "";
			case LANG_ROM:
				return "Confirmati schimbarea modulului in ";
			default:
				return "Change work mode to";
		}
	}
	...
	owner.label_away_temperature = function(language) {
		switch (language) {
			...
			case LANG_ESP:
				return "";
			case LANG_RUS:
				return "Температура в режиме Нет Дома";
			case LANG_BLR:
				return "";
			case LANG_ROM:
	...
	owner.label_feedback = function(language) {
		switch (language) {
			...
			case LANG_BLR:
				return "";
			case LANG_ROM:
				return "Mesaj catre dezvoltatori";
			default:
				return "Feedback";
		}
	}
	...
	owner.label_privacy_policy = function(language) {
		switch (language) {
			...
			case LANG_ESP:
				return "";
			case LANG_RUS:
				return "http://poer.by <br/> ООО Термосмарт <br/> shop@poer.by Политика конфиденциальности";

			case LANG_BLR:
				return "";
			case LANG_ROM:
				return "http://www.poersmart.ro <br/>Informatii la Cristian Dan <br/>cristiandan@poersmart.ro";
			default:
				return "Privacy Policy";
		}
	}
	...
	owner.label_update_schedule = function(language) {
		switch (language) {
			...
			case LANG_BLR:
				return "";
			case LANG_ROM:
				return "Confirmati actualizarea programarii?";
			default:
				return "Update Schedule?";
		}
	}
	...
	owner.label_cannot_override = function(language) {
		switch (language) {
			...
			case LANG_ESP:
				return "";
			case LANG_RUS:
				return "Управление возможно только в режимах: Управление или Дома";
	...
	owner.label_thermostat_tip = function(language) {
		switch (language) {
			...
			case LANG_BLR:
				return "";
			case LANG_ROM:
				return "Scanati codul de bare de pe spatele echipamentului. Daca nu reusiti puteti sa introduceti codul manual.";
			default:
				return "Scan device ID on the device's back.If any trouble on scanning, " + "you may type the ID manually.";
		}
	}
	...
	owner.label_add_radiator = function(language) {
		switch (language) {
			...
			case LANG_BLR:
				return "";
			case LANG_ROM:
				return "Adauga Termostat de Radiator";
			default:
				return "Add Radiator Controller";
		}
	}
	...
	owner.label_buzzer = function(language) {
		switch (language) {
			...
			case LANG_BLR:
				return "";
			case LANG_ROM:
				return "Pornire/oprire sirena avertizare";
			default:
				return "Buzzer:";
		}
	}
	...
	owner.label_set_timezone = function(language) {
		switch (language) {
			...
			case LANG_ESP:
				return "";
			case LANG_RUS:
				return "Выберите зону действия шлюза";
	...
	owner.label_config_title_start = function(language) {
		switch (language) {
			...
			case LANG_BLR:
				return "";
			case LANG_ROM:
				return "Autoconfigurare in curs ...";
			default:
				return "Start Configuration...";
		}
	}
	...
	owner.msg_configuration_failed = function(language) {
		switch (language) {
			...
			case LANG_BLR:
				return "";
			case LANG_ROM:
				return "Configurarea a esuat!<br/>Puteti reincerca din nou acum sau dupa un restart al echipamentelor.";
			default:
				return "Configuration failed!\nYou can click on the button below FAQ for help or try once again!";
		}
	}
	...
	owner.msg_configuration_confirm = function(language) {
		switch (language) {
			...
			case LANG_BLR:
				return "";
			case LANG_ROM:
				return "Asigurati-va ca Gateway-ul a intrat in modul de autoconfigurare (LED-ul de pe acesta clipeste lent,intermitent) iar apoi apasati DA pentru continuarea autoconfigurararii sau NU pentru a reveni si modifica datete de conectare le reteaua Wi-Fi";
			default:
				return "Make sure your gateway device has entered the automatic pairing mode (LED slow blinking lights), after confirmation click \"Yes\" to pair, otherwise click \"No\" to cancel pairing.";
		}
	}
	...
	owner.msg_week_device_need_wait = function(language, times) {
		switch (language) {
			...
			case LANG_RUS:
				return "Устройство в режиме ожидания, ожидайте " + times + " минут.";
			case LANG_BLR:
				return "";
			case LANG_ROM:
	...
	owner.tip_preparationg = function(language) {
		switch (language) {
			...
			case LANG_RUS:
				return "Перед добавлением Шлюза, пожалуйста, вставьте его в розетку и включите режим сопряжения, нажав сенсорный значек POER на шлюзе, пока индикатор не будет мигать медленно";
			case LANG_BLR:
				return "";
			case LANG_ROM:
				return "Inainte de adaugarea Gateway-ului, va rugam sa introduceti Gateway-ul in priza si apoi sa il aduceti in modul de autoconfigurare prin atingerea cca. 5-7 secunde a iconitei de pe acesta ce simbolizeaza o casa, pana cand LED-ul incepe sa clipeasca lent, intermitent.";
			default:
				return "Before add gateway, please plug in the gateway and make it under Paring Mode by long pressing the button until it's LED blinking slowly.";
		}
	}
	...
	owner.msg_add_device_finished = function(language) {
		switch (language) {
			...
			case LANG_BLR:
				return "";
			case LANG_ROM:
				return "Echipamentul a fost adaugat cu succes. Asteptati cca. 3-5 minute pana cand acesta apare in aplicatie si poate fi accesat.";
			default:
				return "Equipment has been added to complete. \n Tip: Check the electrical device, if the device has been powered, please wait 3-5 minutes, the device will automatically on line.";
		}
	}
	...
	owner.msg_ap_config_failure = function(lang_options) {
		switch (language) {
			...
			case LANG_ESP:
				return "";
			case LANG_RUS:
				return "Неудачное подключения шлюза, из-за ошибки DNS сервера либо шлюза. Пожалуйста, свяжитесь с ближайшим сервисцентром или производителем по e-mail: support@poer.by";
			case LANG_BLR:
				return "";
			case LANG_ROM:
	...
	owner.msg_sc_config_fail = function (language) {
		switch (language) {
			...
			case LANG_ESP:
				return "";
			case LANG_RUS:
				return "Ошибка добавления шлюза! Пожалуйста, закройте, выключте шлюз и попробуйте еще раз после перезагрузки шлюза.";
			case LANG_BLR:
				return "";
			case LANG_ROM:
				return "Adaugarea unui nou gateway a esuat. Puteti reincerca din nou acum sau dupa un restart al echipamentelor.";
	...
	owner.msg_config_timeout = function (language) {
		switch (language) {
			...
			case LANG_ESP:
				return "";
			case LANG_RUS:
				return "Тайм-аут конфигурации, пожалуйста, попробуйте еще раз.";
			case LANG_BLR:
				return "";
			case LANG_ROM:
